...
Pour plus de détails sur mon parcours et moi-même, consultez mon CV. [<i class="fa-solid fa-id-card fa-2x fa-pull-right fa-border" style="--fa-border-color: #c3000080; --fa-border-padding: 0.5em; --fa-border-radius: 100%; --fa-border-style: dotted; --fa-border-width: 0.5em;"></i>](index.md)
