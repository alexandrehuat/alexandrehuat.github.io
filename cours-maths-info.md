...
| Sujets enseignés    | Tout le programme scolaire                              | <i class="fa-solid fa-bars-staggered"></i> Algorithmique théorique<br/><i class="fa-brands fa-python"></i> Langage Python<br/><i class="fa-solid fa-chart-simple"></i> Apprentissage statistique<br/><i class="fa-solid fa-code"></i> Bases du web |
